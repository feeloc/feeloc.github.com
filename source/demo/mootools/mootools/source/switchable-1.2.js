...
var Countdown = new Class({
	...
	startRun: function(time, interval) {
		...
		$(this.options.timeRunCls) || document.getElements(this.options.timeRunCls).setStyle('display', 'block');
	...
	endRun: function() {
		...
		$(this.options.timeEndCls) || document.getElements(this.options.timeEndCls).setStyle('display', 'block');
		this.fireEvent('end');
	}
});
